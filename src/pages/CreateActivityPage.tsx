    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-6 flex items-center">
          <Link to="/teacher-dashboard" className="text-gray-500 hover:text-gray-700 mr-2">
        ...
        <Card bordered>
          <div className="p-6">
            <p className="text-gray-500 mb-4">Esta página está em desenvolvimento. Aqui você poderá criar novas atividades para seus alunos.</p>
