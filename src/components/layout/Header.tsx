...
const Header = () => {
  ...
  return (
    <header className="bg-secondary text-white shadow-md relative">
      ...
      {/* Mobile Menu */}
      {isMenuOpen && (
        <div className="absolute top-full left-0 right-0 z-50 md:hidden bg-secondary-dark py-4 shadow-md">
          <div className="container mx-auto px-4">
            <div className="border-b border-gray-700 mb-6 pb-4"></div>
            <nav className="mb-4">
