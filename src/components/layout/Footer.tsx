      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-gray-400 mb-4">
              Plataforma educacional para alunos e professores da FIAP.
            </p>
          </div>
          ...
          <div className="col-span-1">
            ...
            <p className="text-gray-400">Email: contato@nota10.fiap.com.br</p>
            <p className="text-gray-400">Tel: (11) 3385-8010</p>
          </div>
        </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-6 text-center md:text-left">
          <p className="text-gray-400">
            © {new Date().getFullYear()} FIAP Nota 10. Todos os direitos
            reservados.
          </p>
        </div>
      </div>
